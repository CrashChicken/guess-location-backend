...
export class BaseMigration1645642891242 implements MigrationInterface {
    name = 'BaseMigration1645642891242'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "location" ("id" SERIAL NOT NULL, "location" geography(Point,4326) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "image" character varying, "userId" integer, CONSTRAINT "PK_876d7bdba03c72251ec4c2dc827" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_6bad13da63bb61c07334129471" ON "location" USING GiST ("location") `);
        ...
        await queryRunner.query(`CREATE TABLE "guess" ("id" SERIAL NOT NULL, "guessedLocation" geography(Point,4326) NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "locationId" integer, "userId" integer, CONSTRAINT "REL_158dc176376fe3e563cded3c67" UNIQUE ("locationId"), CONSTRAINT "PK_3a695f50b71c117a9fb5b8ff67c" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_6bad13da63bb61c07334129471"`);
